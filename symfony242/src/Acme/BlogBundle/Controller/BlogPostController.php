...
use Acme\BlogBundle\Form\BlogPostType;
...
class BlogPostController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeBlogBundle:BlogPost')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeBlogBundle:BlogPost:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeBlogBundle:BlogPost')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AcmeBlogBundle:BlogPost:edit.html.twig")
     */
